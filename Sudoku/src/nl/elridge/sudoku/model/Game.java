...
public class Game extends Observable {
    ...
    /**
     * Oyunun doğruluğu kontrol edilie
     * 
     */
    ...
    /**
     * Oyunun geçerliliğini kontrol eder
     *
     * @param game                  Oyunun kontrol edilmesi
     * @param index                 Kontrol sırasında kullanılan koşullar
     * @param numberOfSolutions    Bulunan koşul sayısı bir int [] dizisi ile kontrol edilir
     *                              
     * @return                    Eğer hamle geçerli ise dogru (true) degil ise yanlış (false) döner.
     */
     ...
     * Oyun kopyalama
     *
     * @param game      Oyunu kopyalar
     * @return         Kopyalanan oyunun kopyası gönderilir
     */
